...
import { EntryPointContainer, RelayEnvironmentProvider, loadEntryPoint } from "react-relay";
...
if (rootElement) {
  ...
  ReactDOM.render(<RelayEnvironmentProvider environment={modernEnvironment}>
    ...
    </RelayEnvironmentProvider>, rootElement);
}