import type {AddTodoMutation_user$key} from '../../__generated__/relay/AddTodoMutation_user.graphql';
...
export function useAddTodoMutation(userRef: AddTodoMutation_user$key, todoConnectionId: string): (arg0: string) => void {
